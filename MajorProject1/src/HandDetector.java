...
public class HandDetector
{
  ...
  private double hueLower, hueUpper, satLower, satUpper, briLower, briUpper;
...
//                 cvDrawContours(HandPanel.snapIm,bigContour, CV_RGB(0,0,0),CV_RGB(0,0,0),0, CV_FILLED,8,cvPoint(8, 8));
    return bigContour;
