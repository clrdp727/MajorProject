...
*/
      ...
      */
      cvCalcOpticalFlowPyrLK(prevGray, grayGrab, pyramidA, pyramidB,cornersA, cornersB, cornerCount[0], 
...
//        System.out.println(cornerCount);
     ...
     angledDirs array  */
  {
    ...
    System.out.println(angleIndex*ANGLE_RANGE);
